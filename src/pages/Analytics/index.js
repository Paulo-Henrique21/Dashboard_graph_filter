...
import Candlestick from "../../components/Graficos/Candle";
import Volume from "../../components/Graficos/Volume";
  ...
  return (
    ...
    <div className="nav">
      ...
      <div className="graficos">
        ...
        <div className="filter" onClick={() => setOpenProfile((prev) => !prev)}><FaFilter className="icone-filter"/></div>
        {
          openProfile && 
